...
public class Inicializar extends OpcionDeMenu{
	//M閠odo que accesa al tipo de categoria que tiene la opcion inicializar
	public Inicializar(Categoria categoria){
		super(categoria);
	}
	//M閠odo que ejecuta el menu para inicializar
	@Override
	public void ejecutar(){
		...
		System.out.print("Buscando NXT disponibles para conexi贸n...");
		if(nxtinfo.length == 0){
			System.out.println("No se han encontrado NXT, aseg煤rese de tener el bluetooth activado y visible en los NXT y en el PC");
		}
		else{
	...
	//M閠odo sobreescrito de object que esta asignado por defecto, modificado para devolver el tipo de opcion
	@Override
